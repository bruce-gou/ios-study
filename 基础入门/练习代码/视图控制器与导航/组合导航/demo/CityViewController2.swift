...
class CityViewController2: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var data: NSArray = ["昆明","普洱","宝山","临沧","玉溪","昭通","曲靖","丽江"]
    override func viewDidLoad() {
        super.viewDidLoad()
        // 创建视图
        let screen = UIScreen.main.bounds
        self.navigationItem.title = "云南城市"
        // 设置 根视图背景色
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.title = selectName
        vc.url = "https://www.baidu.com/s?wd=%E6%98%86%E6%98%8E"
